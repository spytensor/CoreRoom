...
[GitHub Release](https://github.com/spytensor/CoreRoom/releases) for
your platform and installs it. Supported: linux + macOS, x86_64 and
aarch64.

It also installs `coreroom` as a long-form alias for the same binary in case
`cr` conflicts with another command on your PATH.

For the full project documentation, source, and architecture see
[github.com/spytensor/CoreRoom](https://github.com/spytensor/CoreRoom).
